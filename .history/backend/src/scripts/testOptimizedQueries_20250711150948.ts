...
import OptimizedAuthController from '../controllers/optimized/auth.controller.optimized';
...
async function testOptimizedQueries() {
  ...
  try {
    ...
    if (testUser) {
      ...
      const userImprovement = Math.round(((userOriginalDuration - userOptimizedDuration) / userOriginalDuration) * 100);
