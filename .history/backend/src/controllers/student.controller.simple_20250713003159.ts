...
export class SimpleStudentController {
   ...
   * Target: Fast student updates with cache invalidation
   */
  async updateStudent(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
      ...
      // Check for duplicate registrationId or certificateId if being updated
      ...
      // Update student with optimized response
   ...
   * Target: Fast student deletion with cache cleanup
   */
  async deleteStudent(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
    try {
      ...
      // Delete student (this will cascade to related documents due to foreign key constraints)
