...
export class UserService {
  ...
  static async deleteUser(id: number) {
    ...
    await prisma.$transaction(async (tx) => {
      // First, delete all audit logs associated with this user
    ...
    logger.info(`User deleted: ${user.email} (including ${await prisma.auditLog.count({ where: { userId: id } })} audit logs)`);
