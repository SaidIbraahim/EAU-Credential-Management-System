...
export class DocumentService {
  ...
  async uploadDocumentsParallel(
    ...
    try {
      ...
      console.timeEnd(`⚡ Parallel Upload ${files.length} files`);
      console.log(`🚀 Performance: Uploaded ${files.length} files in parallel!`);
