...
UPDATE "students" SET 
  "temp_first_name" = split_part("fullName", ' ', 1),
...
-- Audit Logs
ALTER TABLE "audit_logs" RENAME "userId" TO "user_id";
ALTER TABLE "audit_logs" RENAME "resourceType" TO "resource_type";
ALTER TABLE "audit_logs" RENAME "resourceId" TO "resource_id";
ALTER TABLE "audit_logs" RENAME "ipAddress" TO "ip_address";
ALTER TABLE "audit_logs" RENAME "userAgent" TO "user_agent";

-- Departments
ALTER TABLE "departments" RENAME "facultyId" TO "faculty_id";
ALTER TABLE "departments" RENAME "createdAt" TO "created_at";
ALTER TABLE "departments" RENAME "updatedAt" TO "updated_at";

-- Documents
ALTER TABLE "documents" RENAME "studentId" TO "student_id";
...
ALTER TABLE "documents" RENAME "createdAt" TO "created_at";
ALTER TABLE "documents" RENAME "updatedAt" TO "updated_at";

UPDATE "documents" SET "url" = CONCAT('https://storage.example.com/', "fileName") WHERE "url" = '';

-- Faculties
ALTER TABLE "faculties" RENAME "createdAt" TO "created_at";
ALTER TABLE "faculties" RENAME "updatedAt" TO "updated_at";

-- Students
ALTER TABLE "students" RENAME "registrationId" TO "registration_id";
ALTER TABLE "students" RENAME "certificateId" TO "certificate_id";
ALTER TABLE "students" RENAME "academicYearId" TO "academic_year_id";
ALTER TABLE "students" RENAME "departmentId" TO "department_id";
ALTER TABLE "students" RENAME "facultyId" TO "faculty_id";
ALTER TABLE "students" RENAME "graduationDate" TO "graduation_date";
ALTER TABLE "students" RENAME "createdAt" TO "created_at";
ALTER TABLE "students" RENAME "updatedAt" TO "updated_at";
...
UPDATE "students" SET 
  ...
  "student_id" = COALESCE("registration_id", CONCAT('STU', id::text));
