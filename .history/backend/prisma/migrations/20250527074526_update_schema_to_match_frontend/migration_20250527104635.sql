...
ALTER TABLE "academic_years" ADD COLUMN "temp_academic_year" TEXT;
ALTER TABLE "academic_years" ADD COLUMN "temp_is_active" BOOLEAN;
UPDATE "academic_years" SET 
  "temp_academic_year" = "academicYear",
  "temp_is_active" = "isActive";

ALTER TABLE "students" ADD COLUMN "temp_first_name" TEXT;
ALTER TABLE "students" ADD COLUMN "temp_last_name" TEXT;
UPDATE "students" SET 
...
-- Step 3: Rename columns and set default values
-- Academic Years
...
ALTER TABLE "audit_logs" 
  ...
  RENAME COLUMN "resourceType" TO "resource_type";
...
ALTER TABLE "departments"
  RENAME COLUMN "facultyId" TO "faculty_id";
...
ALTER TABLE "students"
  ...
  RENAME COLUMN "certificateId" TO "certificate_id",
  RENAME COLUMN "academicYearId" TO "academic_year_id",
  RENAME COLUMN "departmentId" TO "department_id",
  RENAME COLUMN "facultyId" TO "faculty_id",
  RENAME COLUMN "graduationDate" TO "graduation_date",
  RENAME COLUMN "createdAt" TO "created_at",
  RENAME COLUMN "updatedAt" TO "updated_at",
  ADD COLUMN IF NOT EXISTS "first_name" TEXT,
  ADD COLUMN IF NOT EXISTS "last_name" TEXT,
  ADD COLUMN IF NOT EXISTS "student_id" TEXT,
  ADD COLUMN IF NOT EXISTS "enrollment_date" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
  ADD COLUMN IF NOT EXISTS "program" TEXT DEFAULT 'Unknown';
