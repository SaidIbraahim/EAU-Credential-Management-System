...
const StudentFilters = ({
  ...
  const getEssentialFilterCount = () => {
    const essentialFilters = {
      department: filters.department && filters.department !== "all_departments" ? filters.department : "",
      status: filters.status && filters.status !== "all_status" ? filters.status : "",
      academicYear: filters.academicYear && filters.academicYear !== "all_years" ? filters.academicYear : "",
    };
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            <Select
              ...
              onValueChange={(value) => onFilterChange("department", value === "all_departments" ? "" : value)}
            >
          ...
          <div>
            <Select
              value={filters.academicYear || "all_years"}
              onValueChange={(value) => onFilterChange("academicYear", value === "all_years" ? "" : value)}
            >
              <SelectTrigger className="h-10">
          ...
          <div>
            <Select
              ...
              onValueChange={(value) => onFilterChange("status", value === "all_status" ? "" : value)}
            >
              <SelectTrigger className="h-10">
        ...
        {essentialFilterCount > 0 && (
          <div className="flex flex-wrap gap-2 pt-2 border-t border-gray-100">
            ...
            {filters.academicYear && filters.academicYear !== "all_years" && (
              <Badge
                variant="secondary"
            ...
            {filters.status && filters.status !== "all_status" && (
              <Badge
                variant="secondary"
