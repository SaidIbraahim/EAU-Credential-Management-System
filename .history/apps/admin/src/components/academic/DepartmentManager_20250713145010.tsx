...
const DepartmentManager = ({ 
  ...
  const finalDepartments = departments; // Always use fresh data
  const finalFaculties = faculties; // Always use fresh data
  ...
  const isLoading = departmentsLoading || facultiesLoading;
