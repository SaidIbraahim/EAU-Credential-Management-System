...
const StudentDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content - Apple-inspired Clean Layout */}
        ...
        <div className="space-y-3">
          ...
          <Card className="border-0 shadow-sm bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                <div className="space-y-1">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      className="h-7 text-sm border-gray-200 focus:border-blue-400 focus:ring-1 focus:ring-blue-400"
                    />
                  ) : (
                ...
                <div className="space-y-1">
                  <Label htmlFor="registrationId" className="text-xs font-medium text-gray-600">Registration ID</Label>
                  {isEditing ? (
                    <Input
                      id="registrationId"
                    ...
                    <p className="text-sm text-gray-700">{student.registrationId || 'N/A'}</p>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  ...
                  {isEditing ? (
                    ...
                    >
                      <SelectTrigger className="h-7 text-sm border-gray-200 focus:border-blue-400 focus:ring-1 focus:ring-blue-400">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    <p className="text-sm text-gray-700">{student.gender || 'N/A'}</p>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  <Label htmlFor="certificateId" className="text-xs font-medium text-gray-600">Certificate ID</Label>
                  {isEditing ? (
                    <Input
                      id="certificateId"
                    ...
                    <p className="text-sm text-gray-700">{student.certificateId || 'N/A'}</p>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  ...
                  {isEditing ? (
                    ...
                    <Badge variant={student.status === 'CLEARED' ? 'default' : 'secondary'} className="text-xs px-2 py-1">
                      {student.status === 'CLEARED' ? 'Cleared' : 'Un-Cleared'}
                    </Badge>
                  )}
                </div>
          ...
          <Card className="border-0 shadow-sm bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                <div className="space-y-1">
                  <Label htmlFor="faculty" className="text-xs font-medium text-gray-600">Faculty</Label>
                  {isEditing ? (
                    <Select
                ...
                <div className="space-y-1">
                  <Label htmlFor="department" className="text-xs font-medium text-gray-600">Department</Label>
                  {isEditing ? (
                    <Select
                ...
                <div className="space-y-1">
                  <Label htmlFor="academicYear" className="text-xs font-medium text-gray-600">Academic Year</Label>
                  {isEditing ? (
                    <Select
                ...
                <div className="space-y-1">
                  <Label htmlFor="gpa" className="text-xs font-medium text-gray-600">GPA</Label>
                  {isEditing ? (
                    <div className="space-y-1">
                      <Input
                        id="gpa"
                    ...
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-medium text-gray-900">{student.gpa || 'N/A'}/4.0</p>
                      {student.gpa && (
                        <Badge variant={student.gpa >= 3.5 ? 'default' : 'secondary'} className="text-xs px-2 py-1">
                ...
                <div className="space-y-1">
                  <Label htmlFor="grade" className="text-xs font-medium text-gray-600">Grade</Label>
                  {isEditing ? (
                    <div className="space-y-1">
                      <Input
                        id="grade"
                      ...
                      <div className="text-xs text-gray-500 bg-gray-50 px-2 py-1 rounded">
                        A (3.50-4.00) | B (3.00-3.49) | C (2.50-2.99) | D (2.00-2.49) | F (Below 2.00)
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2">
                      <p className="text-sm text-gray-700">{student.grade || 'N/A'}</p>
                ...
                <div className="space-y-1">
                  <Label htmlFor="graduationDate" className="text-xs font-medium text-gray-600">Graduation Date</Label>
                  {isEditing ? (
                    <Input
                      id="graduationDate"
                      type="date"
