...
const StudentDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50/30">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Button variant="ghost" onClick={handleNavigateBack} size="sm" className="text-gray-600 hover:text-gray-900 -ml-2">
                <ArrowLeft className="h-4 w-4 mr-2" />
                Back to Students
              </Button>
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900 leading-tight">
                  {isNewStudent ? "New Student Registration" : student.fullName}
                </h1>
                {!isNewStudent && (
                  <div className="flex items-center gap-3 mt-1">
                    <p className="text-sm text-gray-500">ID: {student.registrationId}</p>
                    <Badge 
                      variant={student.status === 'CLEARED' ? 'default' : 'secondary'} 
            ...
            <div className="flex items-center gap-3">
              {isEditing ? (
                ...
                !isNewStudent && (
                  <Button size="sm" onClick={toggleEditMode} className="bg-gray-900 hover:bg-gray-800 text-white">
      ...
      {/* Main Content - Apple-like Design */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      className="h-10 text-sm border-gray-300 focus:border-blue-500 focus:ring-blue-500/20"
                    />
                  ) : (
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    ...
                    >
                      <SelectTrigger className="h-10 text-sm border-gray-300 focus:border-blue-500 focus:ring-blue-500/20">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  {isEditing ? (
                    <div className="space-y-3">
                      ...
                      {student.gpa && student.gpa >= 0 && student.gpa <= 4 && (
                        <div className="text-xs text-blue-700 bg-blue-50 px-3 py-2 rounded-lg border border-blue-200">
                    ...
                    <div className="bg-gray-50 px-3 py-2 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        {student.gpa && (
                          <Badge 
                            variant={student.gpa >= 3.5 ? 'default' : 'secondary'} 
                            className="text-xs font-medium"
                          >
