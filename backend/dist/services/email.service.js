...
class EmailService {
    static async sendPasswordResetEmail(email, verificationCode, userName) {
        try {
            ...
            console.log('✅ Password reset email sent successfully:', data === null || data === void 0 ? void 0 : data.id);
        }
        catch (error) {
    ...
    static async sendPasswordResetConfirmation(email, userName) {
        try {
            ...
            console.log('✅ Password reset confirmation sent successfully:', data === null || data === void 0 ? void 0 : data.id);
        }
        catch (error) {
    ...
    static getPasswordResetTemplate(verificationCode, userName) {
        return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
    ...
    static getPasswordResetConfirmationTemplate(userName) {
        return `
      <!DOCTYPE html>
      <html lang="en">
      <head>
