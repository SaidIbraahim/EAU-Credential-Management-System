...
import { BarChart3, Download, RefreshCw, Eye } from "lucide-react";

const ReportsSkeleton = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header Skeleton - Match Reports page structure */}
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center gap-1 px-3 py-1 border border-gray-200 rounded-md">
