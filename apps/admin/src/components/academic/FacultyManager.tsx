...
const FacultyManager = ({ preloadedFaculties, isLoading: parentLoading }: FacultyManagerProps) => {
  ...
  // Use preloaded data if provided, otherwise use fresh data
  const finalFaculties = faculties;

  // Combined loading state
  const isLoadingData = isLoading || parentLoading;
