...
const Students = () => {
  ...
  return (
    <div className="space-y-3 p-3 max-w-7xl mx-auto w-full animation-fade-in">
      {/* Compact Header */}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-3 mb-2 h-9">
          <TabsTrigger value="list" className="text-sm">Student List</TabsTrigger>
          <TabsTrigger value="import" className="text-sm">Bulk Import</TabsTrigger>
          <TabsTrigger value="register" className="text-sm">Register Student</TabsTrigger>
        </TabsList>
        
        <TabsContent value="list" className="animation-fade-in mt-2">
          <StudentList 
            students={students} 
            isLoading={isLoading} 
            currentPage={page}
